...
//        int num=Integer.parseInt(str.toString());
    ...
    public static Map<String, String> buildOrderParamMap(String app_id, String out_trade_no,String doublePrices ) {
        ...
        keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\""+doublePrices+"\",\"subject\":\"1\",\"body\":\"meirenmeiba\",\"out_trade_no\":\"" + out_trade_no +  "\"}");
